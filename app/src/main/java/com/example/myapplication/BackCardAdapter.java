...
public class BackCardAdapter extends RecyclerView.Adapter<BackCardAdapter.ViewHolder> {
    ...
    public List<BackCard> list;



    public BackCardAdapter(Context context, List<BackCard> list) {
     ...
     * */
    @Override
    public BackCardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.single_back_card, parent, false);
        return new BackCardAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(BackCardAdapter.ViewHolder holder, final int position) {
        BackCard backCard = list.get(position);

        holder.textName.setText(backCard.getName());
        holder.textDescription.setText(backCard.getDescription());
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Glide.with(context)
                        .asGif()
                        .load(list.get(position).getGif_url())
                        .apply(options)
                        .into(imageView);
